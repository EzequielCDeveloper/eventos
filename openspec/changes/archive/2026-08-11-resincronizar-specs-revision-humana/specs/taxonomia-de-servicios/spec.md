# Delta for Taxonomía de Servicios
...
(Previously: "campo numérico configurable por proveedor" sin inventario por slot ni indicadores)
...
(Previously: No mencionaba que cada paquete tiene precio independiente ajustable por día/temporada)
