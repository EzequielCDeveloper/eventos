# Delta for Interfaces Proveedor
...
(Previously: tabs eran "(1) Reservas, (2) Servicios, (3) Calendario, (4) Chat, (5) Configuración")
...
(Previously: pasos eran "(1) datos personales/empresa, (2) tipo de servicio y configuración, (3) fotos y publicación" sin modo de aprobación en Paso 3)
...
(Previously: "concurrencia máxima de eventos simultáneos" genérico sin inventario por slot ni defaults)
