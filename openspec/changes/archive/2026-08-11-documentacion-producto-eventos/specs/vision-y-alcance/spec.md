...
El producto SHALL operar como marketplace de servicios para eventos (salones, sonidos, servicios-persona) en México. El MVP SHALL incluir particulares Y empresas (posadas, eventos corporativos). Si la complejidad lo exige, el alcance SHALL caer a particulares únicamente.
...
- AND el proveedor es responsable de incluir la comisión en su定价
